      ...
      <div className="mx-auto max-w-4xl px-6 py-8 md:px-12">
        ...
        <div className="mb-12">
          <div className="flex items-start justify-between gap-4 mb-3">
            <p className="text-sm font-semibold tracking-[0.22em] text-(--muted) uppercase">{project.kicker}</p>
            {github && (
              <a
                href={github}
                target="_blank"
        ...
        <section className="mb-12 rounded-2xl border border-(--border) bg-(--surface) px-6 py-5">
          ...
          <p className="text-base leading-relaxed text-(--foreground)/80">{project.outcome}</p>
        </section>
